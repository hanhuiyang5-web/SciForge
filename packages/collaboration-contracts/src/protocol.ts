...
export const restRequestSchema = z.discriminatedUnion('type', [
  ...
  z.object({ ...writeCommandShape, type: z.literal('project.content_space.bind'),
    projectId: projectIdSchema, expectedProjectRevision: revisionSchema,
    expectedBindingRevision: revisionSchema.optional(), rootResourceRefId: resourceRefIdSchema }).strict(),
  z.object({ ...writeCommandShape, type: z.literal('project.content_space.unbind'),
    projectId: projectIdSchema, expectedProjectRevision: revisionSchema,
    expectedBindingRevision: revisionSchema }).strict(),
  z.object({ ...protocolEnvelopeShape, type: z.literal('project.content_space.get'),
    projectId: projectIdSchema }).strict(),
