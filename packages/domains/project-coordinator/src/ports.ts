...
export class AgentRuntimeInvalidResultError extends Error {
  constructor() {
    super('Agent Runtime returned an invalid phase-one Worker result.')
    this.name = 'AgentRuntimeInvalidResultError'
  }
}
