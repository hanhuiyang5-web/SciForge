...
assert_contains "$SCRIPT_DIR/verify-postgres-v5-integration.sh" 'expected_schema_version" == 6'
assert_contains "$SCRIPT_DIR/verify-postgres-v5-integration.sh" '^sciforge_identity_v6_it_[0-9]+_[0-9a-f]{12}$'
assert_contains "$SCRIPT_DIR/verify-postgres-v5-integration.sh" '"event":"postgres.v6.integration","status":"passed"'
assert_contains "$SCRIPT_DIR/verify-postgres-v5-integration.sh" 'v1_to_v5_to_v6_readiness'
...
assert_contains "$SCRIPT_DIR/postgres-v5-integration.mjs" 'runtime.COLLABORATION_SCHEMA_VERSION, 6'
assert_contains "$SCRIPT_DIR/postgres-v5-integration.mjs" 'versionsAtV5, [1, 2, 3, 4, 5]'
assert_contains "$SCRIPT_DIR/postgres-v5-integration.mjs" 'versionsAtV6, [1, 2, 3, 4, 5, 6]'
